...
namespace ldx12::utils
{
	...
	DirectX::XMVECTOR OrbitCamera::GetPosition() const noexcept
	{
		...
		return DirectX::XMVectorSet( horizontalDistance * DirectX::XMScalarSin( yaw ),
	...
	DirectX::XMMATRIX OrbitCamera::GetViewMatrix() const noexcept
	{
		...
		return DirectX::XMMatrixLookToLH( position, direction, DirectX::XMVectorSet( 0.0f, 1.0f, 0.0f, 0.0f ) );
	}
	...
	DirectX::XMMATRIX OrbitCamera::GetSkyViewMatrix() const noexcept
	{
		...
		return DirectX::XMMatrixLookToLH( DirectX::XMVectorZero(), direction, DirectX::XMVectorSet( 0.0f, 1.0f, 0.0f, 0.0f ) );
	}
}
