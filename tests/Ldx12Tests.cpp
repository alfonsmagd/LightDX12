...
int main()
{
	const std::array<TestCase, 14> tests = { TestCase{ "SlotMap creation and properties", TestSlotMapCreationAndProperties },
		...
		TestCase{ "GPU sampler deferred destruction", TestGpuSamplerDeferredDestruction },
		...
		TestCase{ "GPU multisample rendering", TestGpuMultisampleRendering },
		TestCase{ "GPU texture array and cube views", TestGpuTextureArrayAndCubeViews } };
