...
- **Keep the repository focused.** The current tree contains the core library and only two samples. It relies on the Windows SDK rather than a package manager or Git submodules.
